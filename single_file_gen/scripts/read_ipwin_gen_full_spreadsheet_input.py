...
def read_ipwin_func(path, folder_out, offset_e1=0):
    """
    ...
    if identifier == -1:
        ...
        corr = offset_e1 	# offset in electrode 1
            
        # Reading the data
        din = np.genfromtxt(path, delimiter=' ', skiprows=1, usecols=range(4,65))
        
        # Removing unused columns
        din = np.delete(din,range(10,19),1)
        din = np.delete(din, 4, 1)
